...
{
    //kamus
    int i, j, V_Pemenang, V_Dadu1, V_Dadu2, V_SumDadu, Turns, V_GiliranX, V_LokasiPemain, V_HargaSewa, V_HargaJual, V_NilaiKoin, V_Taruhan, V_PemainTerhapus, V_Kesempatan, V_Urutan, V_TotalMaju, V_Temp, V_Urutan1, V_Urutan2;
