...
{
    //kamus
    int i, j, V_Dadu1, V_Dadu2, V_SumDadu, Turns, V_GiliranX, V_LokasiPemain, V_HargaSewa, V_HargaJual, V_NilaiKoin, V_Taruhan, V_PemainTerhapus, V_Kesempatan, V_Urutan, V_TotalMaju;
                ...
                switch(V_Kesempatan){
                    ...
                    case 2:
                    {
                        ...
                        if(V_Pilihan=='y')
                        {
                            ...
                            printf("%d", V_TabPemain.T[V_GiliranX].Urutan);
                            P_Delay(1000);
                            P_PrintGame(V_TabTempat, V_TabPemain);
                            break;
                        }
